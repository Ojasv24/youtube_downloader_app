...
class _$DownloadInfoTearOff {
  ...
  _DownloadInfo call(int current, int total, {ProgressType? type}) {
...
abstract class $DownloadInfoCopyWith<$Res> {
  ...
  $Res call({int current, int total, ProgressType? type});
}
...
class _$_DownloadInfo implements _DownloadInfo {
  const _$_DownloadInfo(this.current, this.total, {this.type});
  ...
  @override
  String toString() {
    return 'DownloadInfo(current: $current, total: $total, type: $type)';
  }
...
abstract class _DownloadInfo implements DownloadInfo {
  const factory _DownloadInfo(int current, int total, {ProgressType? type}) =
      _$_DownloadInfo;
